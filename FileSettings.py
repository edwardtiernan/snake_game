...
settingsdict = {'inputfilename': "Example1.inp", 'root': "BW1", 'constraintfilename': 'Parameter_ranges.txt',
                'filelist': files, 'Qfilelist': Qfiles, 'Unionsetlist': Unionsets, 'distancefilename':
                    "Example1_ModelFinal.inp", 'observationdatafile': "trial_observations.dat", 'weights':
                    [1/4, 1/4, 1/4, 1/4]}

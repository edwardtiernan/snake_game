...
def np_createrandomset():
    ...
    """
    np_new_guess = np.copy(compile_initial_guess(FileSettings.settingsdict['inputfilename']))
...
def par_creategenerations():
    if __name__ != '__main__':
        ...
        p.map(insertguessestoinputfile, FileSettings.settingsdict['Unionsetlist'])
    return
